...
Call log:
  - waiting for locator('a[href="#cart-total-drawer"]').nth(1)
    - locator resolved to <a role="button" aria-expanded="false" href="#cart-total-drawer" data-toggle="mz-pure-drawer" aria-controls="cart-total-drawer" data-total_format="(\d+) item\(s\) \- (.+)" class="cart text-reset text-decoration-none no-title">…</a>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="toast-header">…</div> from <div id="notification-box-top">…</div> subtree intercepts pointer events
...
- generic [ref=f4e1]:
          ...
          - generic [ref=f4e315]:
            ...
            - generic [ref=f4e381]:
              ...
              - list [ref=f4e394]:
                ...
                - listitem [ref=f4e397]: "Viewed: 143978"
  ...
  - alert [ref=f4e540]:
    - generic [ref=f4e541]:
      - generic [ref=f4e542]:
        - generic [ref=f4e543]: 
        - text: 11 item(s) - $1,606.00
      - button "Close" [active] [ref=f4e544] [cursor=pointer]: ×
    - generic [ref=f4e545]:
