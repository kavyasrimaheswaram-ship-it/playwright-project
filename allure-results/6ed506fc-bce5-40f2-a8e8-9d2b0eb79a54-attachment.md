...
Call log:
  ...
  - waiting for locator('//*[@id=\'content\']/h1')
    ...
    - waiting for "https://ecommerce-playground.lambdatest.io/index.php?route=checkout/success" navigation to finish...
...
```ts
  ...
  152 |  // await page.getByRole('heading', { name: ' Your order has been placed!' }).click();
> 153 |    expect(await page.locator("//*[@id='content']/h1")).toContainText(" Your order has been placed!")
      |                                                        ^ Error: expect(locator).toContainText(expected) failed
  154 | 
  155 |     } else {
  156 |         console.log("Alert is not visible");
  157 |     }
  158 | 
  159 |     //await page.locator("").locator("")
  160 |     //await special.addFIrstProductToTheCart();
  161 |     //const isCartVisible=await special.isToastVisible();
  162 |     //expect(isCartVisible).toBeVisible();
  163 | })
  164 | 
  165 | 
  166 | 
