...
```
Error: locator.scrollIntoViewIfNeeded: Error: strict mode violation: getByPlaceholder('Address 1') resolved to 2 elements:
    1) <input value="" type="text" name="address_1" class="form-control" placeholder="Address 1" id="input-payment-address-1"/> aka getByRole('textbox', { name: 'Address 1*' })
    2) <input value="" type="text" class="form-control" placeholder="Address 1" name="shipping[address_1]" id="input-shipping-address-1"/> aka locator('#input-shipping-address-1')

Call log:
  - waiting for getByPlaceholder('Address 1')
              ...
              - row [ref=f5e180]:
                ...
                - cell [ref=f5e184]:
                  - link "HTC Touch HD" [ref=f5e185] [cursor=pointer]:
                    - /url: https://ecommerce-playground.lambdatest.io/index.php?route=product/product&product_id=28
                  - text: "Model: Product 1 Reward Points: 7600"
                - cell "x19" [ref=f5e186]
                - cell "$2,774.00" [ref=f5e187]
          - table [ref=f5e188]:
            - rowgroup [ref=f5e189]:
              - row [ref=f5e190]:
                - cell "Sub-Total:" [ref=f5e191]
                - cell [ref=f5e192]:
                  - strong [ref=f5e193]: $2,280.00
              - row [ref=f5e194]:
              ...
              - row [ref=f5e198]:
                ...
                - cell [ref=f5e200]:
                  - strong [ref=f5e201]: $40.00
              - row [ref=f5e202]:
                - cell "VAT (20%):" [ref=f5e203]
                - cell [ref=f5e204]:
                  - strong [ref=f5e205]: $457.00
              - row [ref=f5e206]:
                - cell "Total:" [ref=f5e207]
                - cell [ref=f5e208]:
                  - strong [ref=f5e209]: $2,782.00
        - generic [ref=f5e211]:
        ...
        - generic [ref=f5e223]:
          - generic [ref=f5e224]:
            ...
            - link "Wishlist" [ref=f5e247] [cursor=pointer]:
              - /url: https://ecommerce-playground.lambdatest.io/index.php?route=account/wishlist
            - button "19" [ref=f5e252] [cursor=pointer]
          - text: 
        - generic [ref=f5e258]:
        ...
        - generic [ref=f5e313]:
          - generic [ref=f5e315]:
            ...
            - generic [ref=f5e321]:
              ...
              - generic [ref=f5e323]:
                - generic [ref=f5e324]:
                  - generic [ref=f5e325]: First Name*
                  - textbox "First Name*" [ref=f5e327]:
                    - /placeholder: First Name
                - generic [ref=f5e328]:
                  - generic [ref=f5e329]: Last Name*
                  - textbox "Last Name*" [ref=f5e331]:
                    - /placeholder: Last Name
                - generic [ref=f5e332]:
                  - generic [ref=f5e333]: Company
                  - textbox "Company" [ref=f5e335]
                - generic [ref=f5e336]:
                  - generic [ref=f5e337]: Address 1*
                  - textbox "Address 1*" [ref=f5e339]:
                    - /placeholder: Address 1
                - generic [ref=f5e340]:
                  - generic [ref=f5e341]: Address 2
                  - textbox "Address 2" [ref=f5e343]
                - generic [ref=f5e344]:
                  - generic [ref=f5e345]: City*
                  - textbox "City*" [ref=f5e347]:
                    - /placeholder: City
                - generic [ref=f5e348]:
                  - generic [ref=f5e349]: Post Code*
                  - textbox "Post Code*" [ref=f5e351]:
                    - /placeholder: Post Code
                - generic [ref=f5e352]:
                  - generic [ref=f5e353]: Country*
                  - combobox "Country*" [ref=f5e355]:
                    ...
                    - option "Zimbabwe"
                - generic [ref=f5e356]:
                  - generic [ref=f5e357]: Region / State*
                  - combobox "Region / State*" [ref=f5e359]:
                    - option "--- Please Select ---"
                    - option "Aberdeen"
                    ...
                    - option "Wrexham"
              - generic [ref=f5e360]:
                - checkbox "My delivery and billing addresses are the same." [checked] [ref=f5e361]
                - generic [ref=f5e362]: My delivery and billing addresses are the same.
            - text: "* * * * * * *"
            - generic [ref=f5e363]:
              - heading "Please select the preferred payment method to use on this order." [level=4] [ref=f5e364]
              - generic [ref=f5e365]:
                - radio "Cash On Delivery" [checked] [ref=f5e366]
                - generic [ref=f5e367]: Cash On Delivery
            - generic [ref=f5e368]:
              - heading "Please select the preferred shipping method to use on this order." [level=4] [ref=f5e369]
              - paragraph [ref=f5e370]:
                - strong [ref=f5e371]: Flat Rate
              - generic [ref=f5e372]:
                - radio "Flat Shipping Rate - $8.00" [checked] [ref=f5e373]
                - generic [ref=f5e374]: Flat Shipping Rate - $8.00
          - generic [ref=f5e376]:
            - generic [ref=f5e377]:
              - table [ref=f5e379]:
                - rowgroup [ref=f5e380]:
                  - row [ref=f5e381]:
                    - columnheader "Image" [ref=f5e382]
                    - columnheader "Product Name" [ref=f5e383]
                    - columnheader "Quantity" [ref=f5e384]
                    - columnheader "Unit Price" [ref=f5e385]
                    - columnheader "Total" [ref=f5e386]
                - rowgroup [ref=f5e387]:
                  - row [ref=f5e388]:
                    - cell [ref=f5e389]:
                      - link [ref=f5e390] [cursor=pointer]:
                        - /url: https://ecommerce-playground.lambdatest.io/index.php?route=product/product&product_id=28
                        - img "HTC Touch HD" [ref=f5e391]
                    - cell [ref=f5e392]:
                      - link "HTC Touch HD" [ref=f5e393] [cursor=pointer]:
                        - /url: https://ecommerce-playground.lambdatest.io/index.php?route=product/product&product_id=28
                      - text: "Model: Product 1 Reward Points: 7600"
                    - cell [ref=f5e394]:
                      - generic [ref=f5e395]:
                        - spinbutton [active] [ref=f5e396]: "1"
                        - generic [ref=f5e397]:
                          - button "" [ref=f5e398] [cursor=pointer]
                          - button "" [ref=f5e400] [cursor=pointer]
                    - cell "$146.00" [ref=f5e402]
                    - cell "$2,774.00" [ref=f5e403]
              - table [ref=f5e404]:
                - rowgroup [ref=f5e405]:
                  - row [ref=f5e406]:
                    - cell "Sub-Total:" [ref=f5e407]
                    - cell [ref=f5e408]:
                      - strong [ref=f5e409]: $2,280.00
                  - row [ref=f5e410]:
                    - cell "Flat Shipping Rate:" [ref=f5e411]
                    - cell [ref=f5e412]:
                      - strong [ref=f5e413]: $5.00
                  - row [ref=f5e414]:
                    - cell "Eco Tax (-2.00):" [ref=f5e415]
                    - cell [ref=f5e416]:
                      - strong [ref=f5e417]: $40.00
                  - row [ref=f5e418]:
                    - cell "VAT (20%):" [ref=f5e419]
                    - cell [ref=f5e420]:
                      - strong [ref=f5e421]: $457.00
                  - row [ref=f5e422]:
                    - cell "Total:" [ref=f5e423]
                    - cell [ref=f5e424]:
                      - strong [ref=f5e425]: $2,782.00
              - generic [ref=f5e426]:
                - generic [ref=f5e427]:
                  - heading "Use Coupon Code " [level=5] [ref=f5e428] [cursor=pointer]:
                    - text: Use Coupon Code
                    - generic [ref=f5e429]: 
                  - generic [ref=f5e432]:
                    - textbox "Enter your coupon here" [ref=f5e433]
                    - button "Apply Coupon" [ref=f5e435] [cursor=pointer]
                - heading "Use Gift Certificate " [level=5] [ref=f5e437] [cursor=pointer]:
                  - text: Use Gift Certificate
                  - generic [ref=f5e438]: 
            - generic [ref=f5e439]:
              - generic [ref=f5e440]: Add Comments About Your Order
              - textbox "Add Comments About Your Order" [ref=f5e441]
            - generic [ref=f5e442]:
              - checkbox "I have read and agree to the Terms & Conditions" [ref=f5e443]
              - generic [ref=f5e444]:
                - text: I have read and agree to the
                - link "Terms & Conditions" [ref=f5e445] [cursor=pointer]:
                  - /url: https://ecommerce-playground.lambdatest.io/index.php?route=information/information/agree&information_id=5
            - paragraph [ref=f5e447]: "* - Fields are required"
            - button "Continue " [ref=f5e448] [cursor=pointer]:
              - text: Continue
              - generic [ref=f5e449]: 
      - contentinfo [ref=f5e450]:
        - paragraph [ref=f5e456]: © LambdaTest - Powered by OpenCart
  - text:  
```
...
```ts
  ...
  100 |         //await page.getByRole('button', { name: 'Update'}).click();
  101 |         // await register.enterFirstName("k");
  102 |         // await register.enterLastName("s");
  103 |         // await register.enteremail("k.1@gmail.com");
  104 |         // await register.enterTelephone("1234567890");
  105 |         // await register.enterPassword("123test");
  106 |         // await register.enterConfirmPassword("123test");
> 107 |         await page.getByPlaceholder('Address 1').scrollIntoViewIfNeeded();
      |                                                  ^ Error: locator.scrollIntoViewIfNeeded: Error: strict mode violation: getByPlaceholder('Address 1') resolved to 2 elements:
  108 |         await page.getByPlaceholder('Address 1').fill("addd");
  109 | 
  110 |         await page.getByRole('textbox',{name:"city"}).type("addd");
  111 |         await page.getByRole('textbox',{name:"postcode"}).type("addd");
  112 |         await page.getByRole('textbox',{name:"address_1"}).type("addd");
  113 |         await page.selectOption("#input-payment-zone", {
  114 |         // label: "Tuesday"
  115 |         // value:"Thursday"
  116 |         index: 5
  117 |      })
  ...
  124 | 
  125 |     } else {
  126 |         console.log("Alert is not visible");
  127 |     }
  128 |    
  129 |     //await page.locator("").locator("")
  130 |         //await special.addFIrstProductToTheCart();
  131 |     //const isCartVisible=await special.isToastVisible();
  132 |     //expect(isCartVisible).toBeVisible();
  133 | })
  134 | 
  135 | 
  136 | 
