...
Call log:
  - waiting for getByPlaceholder('Password Confirm').nth(1)
            ...
            - generic [ref=e293]:
              ...
              - group "Your Password" [ref=e313]:
                - generic [ref=e315]:
                  ...
                  - textbox "Password*" [active] [ref=e318]:
...
```ts
  ...
  20 |         await this.page.getByPlaceholder('Password').nth(0).fill(password);
  21 |     }
  22 |     async enterConfirmPassword(cPassword:string){
> 23 |         await this.page.getByPlaceholder('Password Confirm').nth(1).fill(cPassword);
     |                                                                     ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  24 |     }
