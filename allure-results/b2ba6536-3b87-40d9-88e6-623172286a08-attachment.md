              ...
              - table [ref=f5e404]:
                - rowgroup [ref=f5e405]:
                  ...
                  - row [ref=f5e414]:
                    ...
                    - cell [ref=f5e416]:
                      - strong [ref=f5e417]: $4.00
                  - row [ref=f5e418]:
                    - cell "VAT (20%):" [ref=f5e419]
                    - cell [ref=f5e420]:
                      - strong [ref=f5e421]: $25.00
                  - row [ref=f5e422]:
                    - cell "Total:" [ref=f5e423]
                    - cell [ref=f5e424]:
                      - strong [ref=f5e425]: $154.00
              - generic [ref=f5e426]:
                - generic [ref=f5e427]:
...
> 104 |         page.waitForTimeout(3000)
      |              ^ Error: page.waitForTimeout: Test timeout of 30000ms exceeded.
  105 |         // await register.enterFirstName("k");
  106 |         // await register.enterLastName("s");
  107 |         // await register.enteremail("k.1@gmail.com");
  108 |         // await register.enterTelephone("1234567890");
  109 |         // await register.enterPassword("123test");
  110 |         // await register.enterConfirmPassword("123test");
  111 |         await page.locator('#input-payment-address-1').scrollIntoViewIfNeeded();
  112 |         await page.locator('#input-payment-address-1').fill("addd");
  113 | 
  114 |         await page.locator("#input-payment-city").type("addd");
  115 |         await page.selectOption("#input-payment-country", {
  116 |             // label: "Tuesday"
  117 |             label: "India"
  118 |             //index: 5
  119 |         })
  120 |         await page.selectOption("#input-payment-zone", {
  121 |             label: "Puducherry"
  122 |         })
  123 | 
  124 |         await page.locator("#input-payment-postcode").fill("addd");
  125 |         await page.getByRole('button', { name: 'Continue' }).click();
  126 | 
  127 |     } else {
  128 |         console.log("Alert is not visible");
  129 |     }
  130 | 
  131 |     //await page.locator("").locator("")
  132 |     //await special.addFIrstProductToTheCart();
  133 |     //const isCartVisible=await special.isToastVisible();
  134 |     //expect(isCartVisible).toBeVisible();
  135 | })
  136 | 
  137 | 
  138 | 
