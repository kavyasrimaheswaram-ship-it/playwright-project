...
```
Error: locator.click: SyntaxError: Failed to execute 'querySelectorAll' on 'Document': 'a[aria-controls=["cart-total-drawer"]' is not a valid selector.
...
Call log:
  - waiting for locator('a[aria-controls=["cart-total-drawer"]').nth(1)
          ...
          - table [ref=f4e178]:
            - rowgroup [ref=f4e179]:
              - row [ref=f4e180]:
                ...
                - cell "x2" [ref=f4e186]
                - cell "$292.00" [ref=f4e187]
          - table [ref=f4e188]:
            - rowgroup [ref=f4e189]:
              - row [ref=f4e190]:
                - cell "Sub-Total:" [ref=f4e191]
                - cell [ref=f4e192]:
                  - strong [ref=f4e193]: $240.00
              - row [ref=f4e194]:
                - cell "Eco Tax (-2.00):" [ref=f4e195]
                - cell [ref=f4e196]:
                  - strong [ref=f4e197]: $4.00
              - row [ref=f4e198]:
                - cell "VAT (20%):" [ref=f4e199]
                - cell [ref=f4e200]:
                  - strong [ref=f4e201]: $48.00
              - row [ref=f4e202]:
                - cell "Total:" [ref=f4e203]
                - cell [ref=f4e204]:
                  - strong [ref=f4e205]: $292.00
        - generic [ref=f4e207]:
        ...
        - generic [ref=f4e219]:
          - generic [ref=f4e220]:
            ...
            - link "Wishlist" [ref=f4e243] [cursor=pointer]:
              - /url: https://ecommerce-playground.lambdatest.io/index.php?route=account/wishlist
            - button "3" [ref=f4e248] [cursor=pointer]
          - text: 
        - generic [ref=f4e254]:
          ...
          - generic [ref=f4e315]:
            ...
            - generic [ref=f4e381]:
              ...
              - list [ref=f4e394]:
                ...
                - listitem [ref=f4e397]: "Viewed: 143679"
              ...
              - generic [ref=f4e412]:
                - generic [ref=f4e414]:
                  ...
                  - button "Add to Cart" [active] [ref=f4e425] [cursor=pointer]:
                    - status [ref=f4e426]
                    - text: Add to Cart
                  - button "Buy now" [ref=f4e428] [cursor=pointer]
                - button " Compare this Product" [ref=f4e430] [cursor=pointer]:
                  - generic [ref=f4e431]:
                    - generic [ref=f4e432]: 
                    - text: 
                  - text: Compare this Product
              - generic [ref=f4e434]:
                - button "Size chart" [ref=f4e436] [cursor=pointer]:
                  - generic [ref=f4e437]: 
                  - text: Size chart
                - button "Popup" [ref=f4e439] [cursor=pointer]:
                  - generic [ref=f4e440]: 
                  - text: Popup
                - button "Ask Question" [ref=f4e442] [cursor=pointer]:
                  - generic [ref=f4e443]: 
                  - text: Ask Question
              - separator [ref=f4e445]
              - generic [ref=f4e447]:
                - heading "Online payment" [level=5] [ref=f4e457]
                - heading "Easy Return" [level=5] [ref=f4e466]
                - heading "24x7 Service" [level=5] [ref=f4e477]
              - generic [ref=f4e479]:
                - generic [ref=f4e480]:
                  - generic [ref=f4e481]: 0/50 reviews
                  - generic [ref=f4e482]:
                    - generic [ref=f4e483] [cursor=pointer]: ★ 5
                    - generic [ref=f4e484] [cursor=pointer]: ★ 4
                    - generic [ref=f4e485] [cursor=pointer]: ★ 3
                    - generic [ref=f4e486] [cursor=pointer]: ★ 2
                    - generic [ref=f4e487] [cursor=pointer]: ★ 1
                    - generic [ref=f4e488] [cursor=pointer]: ★ 0
                - heading "Write a review" [level=5] [ref=f4e489]
                - textbox "Your Name" [ref=f4e491]: Kavya Sri
                - textbox "Your Review" [ref=f4e493]
                - button "Write Review" [ref=f4e496] [cursor=pointer]
        - generic [ref=f4e499]:
          - heading "FAQ (Frequently Asked Questions)" [level=3] [ref=f4e500]
          - generic [ref=f4e501]:
            - heading "How can I change my shipping address? " [level=5] [ref=f4e504] [cursor=pointer]:
              - generic [ref=f4e505]: How can I change my shipping address?
              - generic [ref=f4e506]: 
            - heading "How can I change my shipping address? " [level=5] [ref=f4e509] [cursor=pointer]:
              - generic [ref=f4e510]: How can I change my shipping address?
              - generic [ref=f4e511]: 
            - heading "How do I activate my account? " [level=5] [ref=f4e514] [cursor=pointer]:
              - generic [ref=f4e515]: How do I activate my account?
              - generic [ref=f4e516]: 
            - heading "What do you mean by points? How do I earn it? " [level=5] [ref=f4e519] [cursor=pointer]:
              - generic [ref=f4e520]: What do you mean by points? How do I earn it?
              - generic [ref=f4e521]: 
            - heading "Why is there a checkout limit? / What are all the checkout limits? " [level=5] [ref=f4e524] [cursor=pointer]:
              - generic [ref=f4e525]: Why is there a checkout limit? / What are all the checkout limits?
              - generic [ref=f4e526]: 
            - heading "Why must I make payment immediately at checkout? " [level=5] [ref=f4e529] [cursor=pointer]:
              - generic [ref=f4e530]: Why must I make payment immediately at checkout?
              - generic [ref=f4e531]: 
      - contentinfo [ref=f4e532]:
        - paragraph [ref=f4e538]: © LambdaTest - Powered by OpenCart
  - alert [ref=f4e541]:
    - generic [ref=f4e542]:
      - generic [ref=f4e543]:
        - generic [ref=f4e544]: 
        - text: 3 item(s) - $438.00
      - button "Close" [ref=f4e545] [cursor=pointer]: ×
    - generic [ref=f4e546]:
      - paragraph [ref=f4e549]:
        - text: "Success: You have added"
        - link "HTC Touch HD" [ref=f4e550] [cursor=pointer]:
          - /url: https://ecommerce-playground.lambdatest.io/index.php?route=product/product&product_id=28
        - text: to your
        - link "shopping cart" [ref=f4e551] [cursor=pointer]:
          - /url: https://ecommerce-playground.lambdatest.io/index.php?route=checkout/cart
        - text: "!"
      - generic [ref=f4e552]:
        - link "View Cart " [ref=f4e554] [cursor=pointer]:
          - /url: https://ecommerce-playground.lambdatest.io/index.php?route=checkout/cart
          - text: View Cart
          - generic [ref=f4e555]: 
        - link "Checkout " [ref=f4e557] [cursor=pointer]:
