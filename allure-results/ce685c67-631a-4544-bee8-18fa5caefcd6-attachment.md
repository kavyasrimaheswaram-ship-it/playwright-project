              ...
              - table [ref=f5e377]:
                - rowgroup [ref=f5e378]:
                  ...
                  - row [ref=f5e387]:
                    ...
                    - cell [ref=f5e389]:
                      - strong [ref=f5e390]: $8.00
                  - row [ref=f5e391]:
                    - cell "VAT (20%):" [ref=f5e392]
                    - cell [ref=f5e393]:
                      - strong [ref=f5e394]: $73.00
                  - row [ref=f5e395]:
                    - cell "Total:" [ref=f5e396]
                    - cell [ref=f5e397]:
                      - strong [ref=f5e398]: $446.00
              - generic [ref=f5e399]:
                - generic [ref=f5e400]:
...
> 8  |         await  await this.page.getByRole('textbox', { name: 'firstname' }).type(firstname);
     |                                                                            ^ Error: locator.type: Test timeout of 30000ms exceeded.
  9  |     }
