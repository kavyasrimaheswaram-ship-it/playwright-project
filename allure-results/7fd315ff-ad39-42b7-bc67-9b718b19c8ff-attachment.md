...
```ts
  ...
  77 |             this.page.waitForLoadState('domcontentloaded'),
  78 |             await this.page.getByRole('button', { name: 'Confirm Order ' }).click()
  79 |         ])
  80 |     }
  81 |     async successMessage(){
  82 |         await Promise.all([
> 83 |              this.page.waitForLoadState('domcontentloaded')
     |                        ^ Error: page.waitForLoadState: Test ended.
  84 |             
  85 |         ])
  86 |         const Msg = await this.page.getByRole('heading', { name: ' Your order has been placed!' }).textContent();
  87 |         return Msg;
  88 |         
  89 |     }
  90 | 
