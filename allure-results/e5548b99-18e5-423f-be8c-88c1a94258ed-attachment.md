...
- Location: tests\login.spec.ts:45:6

# Error details

```
Error: locator.isVisible: Unsupported token "@class" while parsing css selector "div[@class='alert alert-danger alert-dismissible']". Did you mean to CSS.escape it?
Call log:
    - checking visibility of div[@class='alert alert-danger alert-dismissible']
...
> 38 |           if(await this.page.locator("div[@class='alert alert-danger alert-dismissible']").isVisible())     {
     |                                                                                            ^ Error: locator.isVisible: Unsupported token "@class" while parsing css selector "div[@class='alert alert-danger alert-dismissible']". Did you mean to CSS.escape it?
