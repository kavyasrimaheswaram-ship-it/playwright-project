...
```
Error: locator.textContent: Unsupported token "@class" while parsing css selector "div[@class='alert alert-danger alert-dismissible']". Did you mean to CSS.escape it?
Call log:
  - waiting for div[@class='alert alert-danger alert-dismissible']
