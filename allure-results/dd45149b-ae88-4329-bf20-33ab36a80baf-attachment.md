...
> 20 |         await this.page.getByPlaceholder('Password').type(password);
  ...
  38 |           await this.page.locator("//div[@class='alert alert-danger alert-dismissible']").isVisible()    
  39 |        const msg= await this.page.locator("//div[@class='alert alert-danger alert-dismissible']").textContent();
  40 |        console.log(msg)
  41 |        return msg;
  42 |         
  43 |     }
