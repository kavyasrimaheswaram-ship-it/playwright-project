...
- generic [ref=f5e1]:
            ...
            - generic [ref=f5e321]:
              ...
              - generic [ref=f5e331]:
                ...
                - generic [ref=f5e356]:
                  ...
                  - textbox "Post Code" [active] [ref=f5e359]: addd
                - generic [ref=f5e360]:
  ...
  - text: 
  - button "" [ref=f5e466] [cursor=pointer]
```
...
```ts
  ...
  143 | 
> 144 |         await page.getByRole('checkbox', { name: 'agree' }).click();
      |                                                             ^ Error: locator.click: Test timeout of 30000ms exceeded.
